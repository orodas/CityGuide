...
//edit starts on line 223
//line 358 contains log in credential checking
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
  ...
  /*  private static final String[] DUMMY_CREDENTIALS = new String[]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* mEmailView = (AutoCompleteTextView) findViewById(R.id.TFemail);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.TFpwd);
    ...
    public void onButtonClick(View v) {
        if(v.getId() == R.id.Blogin){
           ...
           /* if(str.equals("user@gmail.com") && pass.equals("hello"))
            {
                Toast yay = Toast.makeText(LoginActivity.this, "Login Successful", Toast.LENGTH_SHORT);
                yay.show();
                Intent i = new Intent(LoginActivity.this, MainActivity.class);
            ...
            {
                Toast boo = Toast.makeText(LoginActivity.this, "Login Failed", Toast.LENGTH_SHORT);
                boo.show();
            }*/
