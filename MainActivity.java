...
import com.robotemplates.cityguide.widget.DrawerDividerItemDecoration;
...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.CategoryViewHolder.OnItemClickListener, OnSearchListener
{
	...
	private void setupRecyclerView()
	{
		...
		RecyclerView.ItemDecoration itemDecoration = new DrawerDividerItemDecoration(
				...
				null,
				dividerPositions,
				getResources().getDimensionPixelSize(R.dimen.global_spacing_8));
	...
	public void onLogOut(View v)
	{
		...
		{
			Toast yay = Toast.makeText(MainActivity.this, "Logout Successful", Toast.LENGTH_SHORT);
			yay.show();
